...
import { useDaysForecast } from "../model/useDaysForecast";
import { DaysForecastBlockSkeleton } from "./DaysForecastBlockSkeleton";

export default function DaysForecastBlock() {
  const { forecast, isError, isLoading } = useDaysForecast();
...
function DayForecastItem({
  ...
  return (
    <div className="w-full flex items-center text-lg lg:text-3xl gap-1 lg:gap-6">
      ...
      <p className="w-20 flex-shrink-0 text-nowrap text-center">
        {temperature}
      </p>
